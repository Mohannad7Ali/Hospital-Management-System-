...
<link href="{{URL::asset('Dashboard/plugins/leaflet/leaflet.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
...
<script src="{{URL::asset('Dashboard/plugins/leaflet/leaflet.js')}}"></script>
<script src="{{URL::asset('Dashboard/js/map-leafleft.js')}}"></script>
@endsection
