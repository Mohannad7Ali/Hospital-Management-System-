...
<link href="{{URL::asset('Dashboard/plugins/sweet-alert/sweetalert.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
...
<script src="{{URL::asset('Dashboard/plugins/sweet-alert/sweetalert.min.js')}}"></script>
<script src="{{URL::asset('Dashboard/plugins/sweet-alert/jquery.sweet-alert.js')}}"></script>
<!-- Sweet-alert js  -->
<script src="{{URL::asset('Dashboard/plugins/sweet-alert/sweetalert.min.js')}}"></script>
<script src="{{URL::asset('Dashboard/js/sweet-alert.js')}}"></script>
@endsection
