...
<link href="{{URL::asset('Dashboard/plugins/fullcalendar/fullcalendar.min.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
							...
							<div class=" card card--calendar p-0 mg-b-20">
								<div class="p-4 border-bottom">
									...
									<div class="text-center mx-auto">
										<img src="{{URL::asset('Dashboard/img/media/calendar.png')}}" alt="calendar" class="ht-80p wd-80p">
									</div>
								</div>
...
@section('js')
<!-- moomet min js -->
<script src="{{URL::asset('Dashboard/plugins/moment/min/moment.min.js')}}"></script>
<!--Internal  Date picker js -->
<script src="{{URL::asset('Dashboard/plugins/jquery-ui/ui/widgets/datepicker.js')}}"></script>
<!--Internal  Fullcalendar js -->
<script src="{{URL::asset('Dashboard/plugins/fullcalendar/fullcalendar.min.js')}}"></script>
...
<script src="{{URL::asset('Dashboard/js/app-calendar-events.js')}}"></script>
<script src="{{URL::asset('Dashboard/js/app-calendar.js')}}"></script>
@endsection
