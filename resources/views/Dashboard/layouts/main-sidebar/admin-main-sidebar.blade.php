<div class="main-sidemenu">
    ...
    <ul class="side-menu">
        <li class="side-item side-item-category">{{ trans('dashboard/main-sidebar_trans.title') }}</li>
        <li class="slide">
            <a class="side-menu__item" href="{{ url('/' . ($page = 'index')) }}"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                </svg><span class="side-menu__label">{{ trans('dashboard/main-sidebar_trans.home') }}</span></a>
        </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('sections.index') }}">{{ trans('dashboard/main-sidebar_trans.view_all') }}</a>
                </li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('Doctors.doctors') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ url('/' . ($page = 'Doctors')) }}">{{ trans('Doctors.view_all') }}</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    <path
                        d="M22 9h-4.79l-4.38-6.56c-.19-.28-.51-.42-.83-.42s-.64.14-.83.43L6.79 9H2c-.55 0-1 .45-1 1 0 .09.01.18.04.27l2.54 9.27c.23.84 1 1.46 1.92 1.46h13c.92 0 1.69-.62 1.93-1.46l2.54-9.27L23 10c0-.55-.45-1-1-1zM12 4.8L14.8 9H9.2L12 4.8zM18.5 19l-12.99.01L3.31 11H20.7l-2.2 8zM12 13c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" />
                </svg><span class="side-menu__label">{{ trans('Services.Services') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('Service.index') }}">{{ trans('dashboard/main-sidebar_trans.Single_service') }}</a>
                </li>
                <li><a class="slide-item"
                        href="{{ route('AddServicesGroup') }}">{{ trans('dashboard/main-sidebar_trans.group_services') }}</a>
                </li>
                <li><a class="slide-item"
                        href="{{ url('/' . ($page = 'insurance')) }}">{{ trans('dashboard/main-sidebar_trans.Insurance') }}</a>
                </li>
                <li><a class="slide-item"
                        href="{{ url('/' . ($page = 'Ambulance')) }}">{{ trans('dashboard/main-sidebar_trans.ambulance') }}</a>
                </li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('dashboard/main-sidebar_trans.patients') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ url('/' . ($page = 'Patients')) }}">{{ trans('Doctors.view_all') }}</a></li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ url('/' . ($page = 'single_invoices')) }}">فواتير الخدمة
                        المفردة</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('dashboard/main-sidebar_trans.accounts') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('Receipt.index') }}">{{ trans('dashboard/main-sidebar_trans.receipt') }}</a>
                </li>
                <li><a class="slide-item"
                        href="{{ route('Payment.index') }}">{{ trans('dashboard/main-sidebar_trans.payment') }}</a>
                </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('ray_employee.index') }}">قائمة الموظفين</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'form-advanced')) }}">قائمة الكشوفات</a>
                </li>
