    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">كشوفات الأشعة</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('bbbbb') }}">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">Advanced UI</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
