...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المريض</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ التفاصيل
                    والحسابات</span>
            </div>
        </div>
    </div>
                                                ...
                                                <table class="table table-hover text-md-nowrap text-center" id="example1">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="alert alert-{{ $Debit - $credit > 0 ? 'danger' : ($Debit - $credit < 0 ? 'success' : '') }}">
                                                                <span
                                                                    class="text-{{ $Debit - $credit > 0 ? 'danger' : ($Debit - $credit < 0 ? 'success' : 'primary') }}">{{ $Debit - $credit }}</span>
                                                                @if ($Debit - $credit > 0)
                                                                    مدين
                                                                @elseif ($Debit - $credit < 0)
                                                                    دائن
                                                                @else
                                                                    0000
                                                                @endif
