        ...
        <form wire:submit.prevent="saveGroup" autocomplete="off">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                            ...
                            @foreach ($GroupsItems as $index => $groupItem)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <input type="number"
                                                   class="form-control" wire:model.live="GroupsItems.{{$index}}.quantity"/>
                                        @endif
                                    </td>
                                    <td>
                                        @if($groupItem['is_saved'])
                    ...
                    <br/>
                    <div>
                        <input class="btn btn-outline-success" type="submit" wire:loading.remove value="تاكيد البيانات">
                        <span wire:loading style="color: green">Uploading...</span>
                    </div>
                </div>
            </div>
