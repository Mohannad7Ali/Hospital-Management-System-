<div>
    <button class="btn btn-primary pull-right" wire:click.prevent="show_form_add" type="button">اضافة فاتورة
        جديدة
    </button><br><br>
            ...
            <tbody>
                @foreach ($single_invoices as $single_invoice)
                    <tr>
                        ...
                        <td>
                            <button wire:click.prevent="edit({{ $single_invoice->id }})"
                                class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></button>
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                data-target="#delete_invoice" wire:click.prevent="delete({{ $single_invoice->id }})"><i
                                    class="fa fa-trash"></i></button>
                            <button wire:click.prevent="print({{ $single_invoice->id }})"
                                class="btn btn-primary btn-sm"><i class="fas fa-print"></i></button>
                        </td>
                    </tr>
                @endforeach
        </table>
